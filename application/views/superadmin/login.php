...
<head>
        ...
        <link rel="stylesheet" href="<?php echo base_url();?>assets/superadmin/css/matrix-login.css" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="index.html">
				 <div class="control-group normal_text"> <h3><img src="<?php echo base_url();?>assets/superadmin/img/logo.png" alt="Logo" /></h3></div>
        ...
        <script src="<?php echo base_url();?>assets/superadmin/js/matrix.login.js"></script> 
    </body>
